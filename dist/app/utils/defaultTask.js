...
const contents_models_1 = __importDefault(
  require('../modules/contents/contents.models'),
);
...
function defaultTask() {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    const admin = yield user_models_1.User.findOne({
      role:
        user_constants_1.USER_ROLE === null ||
        user_constants_1.USER_ROLE === void 0
          ? void 0
    ...
    if (!admin) {
      yield user_models_1.User.create({
        ...
        email: 'bdcalling.ashraf@gmail.com',
