...
const confirmPayment = (query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        //   );
        // }
        if (((_a = subscription === null || subscription === void 0 ? void 0 : subscription.package) === null || _a === void 0 ? void 0 : _a.durationType) === 'monthly') {
            expiredAt = expiredAt.add(30, 'days'); // Add 30 days for monthly subscriptions
        }
        else if (((_b = subscription === null || subscription === void 0 ? void 0 : subscription.package) === null || _b === void 0 ? void 0 : _b.durationType) === 'yearly') {
            expiredAt = expiredAt.add(365, 'days'); // Add 365 days for yearly subscriptions
        }
...
const dashboardData = (query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const administrator = yield user_models_1.User.countDocuments({
        role: user_constants_1.USER_ROLE === null || user_constants_1.USER_ROLE === void 0 ? void 0 : user_constants_1.USER_ROLE.administrator,
    });
    ...
    const monthlyUser = yield user_models_1.User.aggregate([
        {
            $match: {
                ...
                role: query.role === 'customer' ? user_constants_1.USER_ROLE.user : user_constants_1.USER_ROLE.administrator,
                createdAt: {
...
const createPayments = () => __awaiter(void 0, void 0, void 0, function* () { });
const getAllPayments = () => __awaiter(void 0, void 0, void 0, function* () { });
const getPaymentsById = () => __awaiter(void 0, void 0, void 0, function* () { });
const updatePayments = () => __awaiter(void 0, void 0, void 0, function* () { });
const deletePayments = () => __awaiter(void 0, void 0, void 0, function* () { });
